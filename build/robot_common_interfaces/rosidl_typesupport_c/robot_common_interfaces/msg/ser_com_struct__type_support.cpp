...
static const _SerComStruct_type_support_symbol_names_t _SerComStruct_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_common_interfaces, msg, SerComStruct)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robot_common_interfaces, msg, SerComStruct)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robot_common_interfaces, msg, SerComStruct)() {
  return &::robot_common_interfaces::msg::rosidl_typesupport_c::SerComStruct_message_type_support_handle;
}
