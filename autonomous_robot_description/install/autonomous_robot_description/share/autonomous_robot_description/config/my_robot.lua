...
options = {
  ...
  use_pose_extrapolator = true, -- Use a pose extrapolator for smooth pose estimates
...
-- Activate pure localization mode
--TRAJECTORY_BUILDER.pure_localization = true -- Ensure this is defined only once
...
TRAJECTORY_BUILDER_2D.real_time_correlative_scan_matcher.translation_delta_cost_weight = 0.1 -- Weight for translation deltas
TRAJECTORY_BUILDER_2D.real_time_correlative_scan_matcher.rotation_delta_cost_weight = 0.1 -- Weight for rotation deltas
