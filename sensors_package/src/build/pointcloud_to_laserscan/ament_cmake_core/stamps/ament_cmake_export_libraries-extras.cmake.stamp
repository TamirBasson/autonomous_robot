...
set(_exported_libraries "pointcloud_to_laserscan")
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING
          "Package 'pointcloud_to_laserscan' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND pointcloud_to_laserscan_LIBRARIES ${_cfg} "${_lib}")
