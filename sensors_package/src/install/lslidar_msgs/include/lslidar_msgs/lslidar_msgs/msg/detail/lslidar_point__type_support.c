...
static rosidl_typesupport_introspection_c__MessageMember lslidar_msgs__msg__LslidarPoint__rosidl_typesupport_introspection_c__LslidarPoint_message_member_array[8] = {
  {
    "time",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(lslidar_msgs__msg__LslidarPoint, ring),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
