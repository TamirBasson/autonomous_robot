...
class Init_LslidarPoint_ring
{
public:
  explicit Init_LslidarPoint_ring(::lslidar_msgs::msg::LslidarPoint & msg)
  : msg_(msg)
  {}
  ::lslidar_msgs::msg::LslidarPoint ring(::lslidar_msgs::msg::LslidarPoint::_ring_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_LslidarPoint_ring intensity(::lslidar_msgs::msg::LslidarPoint::_intensity_type arg)
  {
    msg_.intensity = std::move(arg);
    return Init_LslidarPoint_ring(msg_);
  }
