...
#ifndef LSLIDAR_MSGS__SRV__DETAIL__DESTINATION_IP__FUNCTIONS_H_
#define LSLIDAR_MSGS__SRV__DETAIL__DESTINATION_IP__FUNCTIONS_H_
...
/// Initialize srv/DestinationIp message.
/**
...
/// Finalize srv/DestinationIp message.
/**
...
/// Create srv/DestinationIp message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * lslidar_msgs__srv__DestinationIp_Request__init().
...
/// Destroy srv/DestinationIp message.
/**
 * It calls
 * lslidar_msgs__srv__DestinationIp_Request__fini()
...
/// Check for srv/DestinationIp message equality.
/**
...
/// Copy a srv/DestinationIp message.
/**
...
/// Initialize array of srv/DestinationIp messages.
/**
...
/// Finalize array of srv/DestinationIp messages.
/**
 * It calls
 * lslidar_msgs__srv__DestinationIp_Request__fini()
...
/// Create array of srv/DestinationIp messages.
/**
 * It allocates the memory for the array and calls
 * lslidar_msgs__srv__DestinationIp_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/DestinationIp messages.
/**
 * It calls
 * lslidar_msgs__srv__DestinationIp_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/DestinationIp message array equality.
/**
...
/// Copy an array of srv/DestinationIp messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * lslidar_msgs__srv__DestinationIp_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_lslidar_msgs
...
/**
 * It calls
 * lslidar_msgs__srv__DestinationIp_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_lslidar_msgs
...
/**
 * It allocates the memory for the array and calls
 * lslidar_msgs__srv__DestinationIp_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_lslidar_msgs
...
/**
 * It calls
 * lslidar_msgs__srv__DestinationIp_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // LSLIDAR_MSGS__SRV__DETAIL__DESTINATION_IP__FUNCTIONS_H_
